...
You can follow the [Server Setup For Pipeline](https://github.com/saeedalig/DevOps-Project/tree/main/Server-Setup-For-Pipeline) guide.Feel free to use by customizing it as per your needs.
